...
function newfrmFeats()
    ...
    obj.button1:setHint("Informações do Feature");
    ...
    obj.button2:setHint("Apagar Feature");
    obj.button2:setWidth(30);
    obj.button2:setMargins({left=10});
    obj.button2:setName("button2");

    obj.featPopUp = gui.fromHandle(_obj_newObject("popup"));
    obj.featPopUp:setParent(obj);
    obj.featPopUp:setName("featPopUp");
    obj.featPopUp:setWidth(500);
    obj.featPopUp:setHeight(400);
    obj.featPopUp:setBackOpacity(0.5);

    obj.layout5 = gui.fromHandle(_obj_newObject("layout"));
    obj.layout5:setParent(obj.featPopUp);
    ...
    obj.layout6:setParent(obj.featPopUp);
    ...
    obj.layout7:setParent(obj.featPopUp);
    ...
    obj.layout8:setParent(obj.featPopUp);
    ...
    obj.edit8:setField("featTrigger");
    ...
    obj.layout9:setParent(obj.featPopUp);
    ...
    obj.layout10:setParent(obj.featPopUp);
    ...
    obj.layout11:setParent(obj.featPopUp);
    ...
    obj.textEditor1:setField("featDesc");
    ...
    function obj:destroy() 
        ...
        if self.featPopUp ~= nil then self.featPopUp:destroy(); self.featPopUp = nil; end;
