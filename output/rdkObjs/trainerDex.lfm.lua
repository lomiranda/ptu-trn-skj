...
function newfrmDex()
    ...
    obj.button1:setHint("Informações do Pokémon");
    ...
    obj.button2:setHint("Apagar Entrada");
    obj.button2:setWidth(20);
    obj.button2:setMargins({left=5, right=10});
    ...
    obj._e_event0 = obj.button1:addEventListener("onClick",
        function (self)
            local pop = self:findControlByName("pokePopUp");
            				
            					if pop ~= nil then
            						pop:setNodeObject(self.sheet);
            						pop:showPopupEx("center", self.AtrBut);
            					else
            						showMessage("Ops, bug.. nao encontrei o popup da Entrada para exibir");
            					end;
        end, obj);
